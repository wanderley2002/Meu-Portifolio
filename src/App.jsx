      ...
      <footer id="contact" className="border-t border-gray-800 bg-[#080b0f] py-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-gray-500 text-sm">Idade: 24 anos • Nascimento: 20/08/2002</p>
            <div className="mt-2 flex flex-col gap-1 text-sm text-gray-400">
              <a href="mailto:wanderleyariel7@gmail.com" className="hover:text-cyan-400 transition-colors">
                Email: wanderleyariel7@gmail.com
              </a>
              <a href="tel:+5511951681760" className="hover:text-cyan-400 transition-colors">
                Telefone: (11) 95168-1760
              </a>
              <a href="tel:+5511999776584" className="hover:text-cyan-400 transition-colors">
                Telefone: (11) 99977-6584
              </a>
            </div>
          </div>
          <div className="flex gap-4">
            <a href="https://github.com/wanderley2002" target="_blank" rel="noreferrer" className="p-3 rounded-lg bg-gray-900 border border-gray-800 text-gray-400 hover:text-white hover:border-cyan-500/50 transition-all">
            ...
            <a href="https://www.linkedin.com/in/wanderley-ariel" target="_blank" rel="noreferrer" className="p-3 rounded-lg bg-gray-900 border border-gray-800 text-gray-400 hover:text-white hover:border-cyan-500/50 transition-all">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 10.9v8.37H9.25V10.9H6.46M7.86 6.72a1.47 1.47 0 1 0 0 2.94 1.47 1.47 0 0 0 0-2.94z"/>
              </svg>
            </a>
            <a href="mailto:wanderleyariel7@gmail.com" className="p-3 rounded-lg bg-gray-900 border border-gray-800 text-gray-400 hover:text-white hover:border-cyan-500/50 transition-all">
              <Mail size={20} />
            </a>
          </div>
        </div>
